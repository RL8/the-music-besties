...
console.log('Updating backend URL in .env.master...');
...
try {
  ...
  // Update the BACKEND_URL to the Railway deployed URL
  const railwayBackendUrl = 'https://mb-api-service-production.up.railway.app';
